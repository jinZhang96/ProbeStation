...
namespace Main
{
    partial class ModelParams
    {
        ...
        public static double PickHeight
        {
            get
            {
                return _stdPickPos.DblValue3 + _adjPickPos.DblValue3 + confGlassThicknes;
            }
        }
        /// <summary>
        /// 粗定位取片位，发送给机器人的基准位
        ...
        static Point4D _adjPickPos
        {
            get
            {
                return UnifyAdj(ParBotAdj.P_I[(int)BotAdj.PickPos]);
            }
        }
        /// <summary>
        /// 取片后偏移，调整值
        ...
        static Point4D _stdPickPos
        {
            get
            {
                return ParBotStd.P_I[(int)BotStd.PickPos];
            }
        }
