    ...
    public partial class BaseDealComprehensiveResult_Main
    {
        ...
        public StateComprehensive_enum CalibStdValue(int index, string cellName)
        {
            try
            {
                ...
                Point2D offset = new Point2D((ModelParams.IfMirrior ? -1 : 1) * ModelParams.MonoGlassX / 2 / AMP, ModelParams.MonoGlassY / 2 / AMP);
                offset = TransDelta(offset, r1, 0);
                double rcX = CalibDataMngr.instance.CalibPos_L[0].DblValue1 + (ModelParams.IfMirrior ? -1 : 1) * ModelParams.MonoGlassX / 2 / AMP;
