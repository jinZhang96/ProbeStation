...
namespace Main_EX
{
    partial class BaseDealComprehensiveResult
    {
        ...
        public static bool BlFinishPos_Cam2 = false;//相机2处理完成
        public static bool BlFinishPos_Cam3 = false;//相机3处理完成
        ...
        #region 插拔模式参数定义
        public static bool BlResultPos4;
        public static bool BlResultPos3;
        public static bool BlResultPos2;
        public static bool BlResultPos1;

        public static bool BlFinishPos4;
        public static bool BlFinishPos3;
        public static bool BlFinishPos2;
        public static bool BlFinishPos1;

        public static bool BlFinishPos1_Cam2 = false;//相机1处理完成
        public static bool BlFinishPos2_Cam2 = false;//相机2处理完成

        public static bool BlFinishPos3_Cam2 = false;//相机1处理完成
        public static bool BlFinishPos4_Cam2 = false;//相机2处理完成

        public static bool BlResultPos1_Cam2 = false;//相机1处理结果
        public static bool BlResultPos2_Cam2 = false;//相机2处理结果

        public static bool BlResultPos3_Cam2 = false;//相机1处理结果
        public static bool BlResultPos4_Cam2 = false;//相机2处理结果
        #endregion
        #endregion 定义
