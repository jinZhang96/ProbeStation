...
namespace ModulePackage
{
    public class ModuleBase
    {
        ...
        public static bool CalibRotateCenter(string cellName, Point2D pt2Mark1, Point2D pt2Mark2, double rotateAngle, BaseParComprehensive baseParComprehensive)
        {
            try
            {
                //获取旋转中心cell
        ...
        public static bool VerifyRotateCenter(Point2D pt2SrcMark1, Point2D pt2SrcMark2, Point2D pt2DstMark1, Point2D pt2DstMark2, double r, double disMark, double ratio, double thread)
        {
