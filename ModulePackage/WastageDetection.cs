...
namespace ModulePackage
{
    public class WastageDetection : ModuleBase
    {
        ...
        /// <returns></returns>
        public static bool CalcSharpnessRatio(List<double> list, double thread, int cameraNo, int id, bool ifRecord, out double[] dblResult)
        {
        ...
        /// <returns></returns>
        public static bool CalcSharpnessRatio(List<double> list, double thread, int cameraNo, int defaultCamNo, bool singleE, int id, bool ifRecord, out double[] dblResult)
        {
            dblResult = new double[3];
            try
            {
