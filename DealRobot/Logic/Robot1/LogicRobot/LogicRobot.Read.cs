...
namespace DealRobot
{
    partial class LogicRobot
    {
        ...
        public event IntAction PreciseResult_event;
        ...
        public event StrAction Msg_event;
        public event StrAction Alarm_event;
        public event StrAction Sig_event;

        public event StrAction Version_event;//版本号
        #endregion 定义事件
        ...
        public void TrrigerRobot(string str)
        {
            try
            {
                ...
                switch (Head)
                {
                    ...
                    case "VERSION"://机器人程序版本号 日期+修改人+版本号（20190124-ZX-1.0）
                        Version_event(version);
                        break;
                    case "PreciseOK":      ///通知PLC精定位拍照结果
                        PreciseResult_event(1);
                        break;
                    case "PreciseNG":
                        PreciseResult_event(2);
                        break;
                    ...
                    case "Delay"://超时
                        ...
                        break;
                    case "MSG":
                        Msg_event(msg_array[intValue]);
                        break;
                    case "ALARM":
                        Alarm_event(alarm_array[intValue]);
                        break;
                    case "SIG":
                        Sig_event("发送信号给PLC:" + str);
                        break;
                    default:                        
                        break;
                }
