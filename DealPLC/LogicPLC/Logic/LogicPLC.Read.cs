...
namespace DealPLC
{
    public partial class LogicPLC
    {
        ...
        /// 读取单个寄存器
        /// </summary>
        public bool ReadReg(string reg, out int value)
        {
            value = 0;
            g_MtRead.WaitOne();
            try
            {
                ...
                {
                    blResult = PortPLC_I.g_BasePortPLC.ReadReg(reg, out value);
                }                
        ...
        /// 批量读取寄存器
        /// </summary>
        public bool ReadBlockReg(string reg, int num, string namefun, out int[] value)
        {
        ...
        /// 批量读取寄存器，连续地址
        /// </summary>
        public bool ReadBlockReg_Continue(string reg, int num, string namefun, out int[] value)
        {
            g_MtReadBlock.WaitOne();
            value = null;
            try
